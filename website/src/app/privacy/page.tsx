...
function SectionHeading({ id, icon, children }: { id: string; icon: React.ReactNode; children: React.ReactNode }) {
  return (
    <h2 id={id} className="flex items-center gap-3 font-display font-bold text-xl text-slate-900 mt-12 mb-4 scroll-mt-24">
    ...
    <main className="min-h-screen overflow-x-hidden">
      ...
      <section className="pt-28 lg:pt-36 pb-16 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-6 lg:px-8 text-center">
          ...
          <h1 className="font-display font-extrabold text-4xl sm:text-5xl text-slate-900 tracking-tight mb-4">
            Your privacy is a{' '}
            <span className="text-gradient">core feature</span>
          </h1>
          <p className="text-slate-500 max-w-xl mx-auto leading-relaxed mb-3">
            We built SheetMind so your spreadsheet data never has to leave your control.
          </p>
      ...
      <div className="bg-slate-50/50 border-y border-slate-100">
        <div className="max-w-3xl mx-auto px-6 lg:px-8 py-8">
          <p className="text-xs font-display font-semibold uppercase tracking-widest text-slate-400 mb-4">Our three core commitments</p>
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              {
                icon: (
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><path d="M3 3l7.07 16.97 2.51-7.39 7.39-2.51L3 3z" /><path d="M13 13l6 6" /></svg>
                ),
                title: 'Sheet data is never stored',
                desc: 'Processed in memory, discarded immediately after each response.',
              },
              {
                icon: (
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><circle cx="12" cy="12" r="10" /><path d="M18 6L6 18M6 6l12 12" /></svg>
                ),
                title: 'Your data is never sold',
                desc: 'We do not share, sell, or trade your data with any third parties.',
              },
              {
                icon: (
                ...
                desc: 'Your content is never used to train or improve AI models.',
              },
            ].map((item) => (
            ...
            <div className="sticky top-24">
              ...
              <div className="mt-8 p-4 rounded-xl bg-emerald-50 border border-emerald-100">
                <p className="text-xs text-slate-500 leading-relaxed">
                  Questions?{' '}
                  <a href="mailto:privacy@sheetmind.xyz" className="text-emerald-600 font-medium hover:underline">Email us</a>
                </p>
              </div>
            </div>
          </aside>
          ...
          <article className="max-w-2xl">
            <div className="divide-y divide-slate-100">
              ...
              <div className="pb-10">
                ...
                <P>SheetMind (&quot;we&quot;, &quot;our&quot;, &quot;us&quot;) is committed to protecting your privacy. This policy explains how we collect, use, and safeguard your information when you use our Google Sheets sidebar addon and website.</P>
              </div>
              ...
              <div className="py-10">
                ...
                }>Data We Collect</SectionHeading>
                <div className="space-y-3">
                  {[
                    ...
                    { label: 'Sheet data (temporary)', text: 'When you send a message in the SheetMind sidebar, the relevant sheet data is sent to our backend for AI processing. This data is NOT stored permanently — it is processed in memory and discarded after the response is generated.' },
                    ...
                    { label: 'Usage data', text: 'We track anonymized usage metrics (message counts, feature usage, session data) via PostHog analytics. We never track the content of your messages or sheet data.' },
                  ].map((item) => (
              ...
              <div className="py-10">
                ...
                }>What We Never Do</SectionHeading>
                <UL>
              ...
              <div className="py-10">
                ...
                }>PII Detection</SectionHeading>
                <div className="p-4 rounded-xl bg-amber-50 border border-amber-200/60 mb-4 flex items-start gap-3">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#d97706" strokeWidth="2" strokeLinecap="round" className="flex-shrink-0 mt-0.5">
                    <path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z" /><path d="M12 9v4M12 17h.01" />
                  </svg>
                  <p className="text-sm text-amber-800 leading-relaxed"><strong>You are always in control.</strong> SheetMind warns you before processing any data that may contain sensitive information.</p>
                </div>
                <P>SheetMind includes automatic PII detection. Before processing your sheet data, we scan for patterns that may indicate sensitive information (emails, phone numbers, SSNs, etc.) and display a warning banner. This detection happens before data is sent to external AI services — you decide whether to proceed.</P>
              </div>
              ...
              <div className="py-10">
                ...
                }>Third-Party Services</SectionHeading>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={item.name} className="flex items-start gap-3 p-4 rounded-xl border border-slate-200/60 bg-white">
                      ...
                      <p className="text-sm text-slate-600"><span className="font-semibold text-slate-800">{item.name}: </span>{item.desc}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="py-10">
                ...
                }>Data Security</SectionHeading>
                <P>We implement row-level security (RLS) policies on all database tables, ensuring users can only access their own data. All data is transmitted over HTTPS. Authentication tokens are securely stored and never exposed.</P>
              </div>
              ...
              <div className="py-10">
                ...
                }>Data Retention</SectionHeading>
                <P>Account data is retained as long as your account is active. Conversation history is retained until you delete it or close your account. Sheet data is never retained — it is processed in memory and immediately discarded.</P>
              </div>

              <div className="py-10">
                <SectionHeading id="rights" icon={
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" /><circle cx="9" cy="7" r="4" /></svg>
                }>Your Rights</SectionHeading>
              ...
              <div className="pt-10">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-5 rounded-xl bg-slate-50 border border-slate-200/60">
                  ...
                  <a href="mailto:privacy@sheetmind.xyz" className="btn-primary text-sm">
                    privacy@sheetmind.xyz
                  </a>
                </div>
                <p className="mt-6 text-sm text-slate-400">Also see our <a href="/terms" className="text-emerald-600 hover:underline">Terms of Service</a>.</p>
              </div>
