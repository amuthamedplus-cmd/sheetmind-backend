...
function Header({
  ...
  return (
    <header className="border-b border-gray-100 bg-white flex-shrink-0 relative">
      {/* Top accent bar */}
      ...
      <div className="px-4 py-2.5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-md shadow-emerald-200/40">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              className="p-1.5 text-gray-400 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg transition-all active:scale-[0.93]"
              title="New Chat"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
            ...
            {user && (
              ...
              >
                {user.avatar_url ? (
                  ...
                  <div className="w-7 h-7 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 text-white flex items-center justify-center">
                    {userInitial}
                  </div>
                )}
              </button>
      ...
      {showUserMenu && user && (
        <div
          ref={userMenuRef}
          className="absolute top-full right-0 z-50 w-56 bg-white border border-gray-100 rounded-xl shadow-xl shadow-gray-200/50 mt-1 mr-3 animate-slide-down overflow-hidden"
        >
          <div className="px-4 py-3 border-b border-gray-50">
            <div className="flex items-center gap-2.5">
              {user.avatar_url ? (
                ...
                <div className="w-9 h-9 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 text-white flex items-center justify-center text-sm font-bold">
                  {userInitial}
                </div>
              )}
          ...
          {usageUsed !== null && usageLimit !== null && (
            <div className="px-4 py-2.5 border-b border-gray-50">
              <div className="flex items-center justify-between mb-1.5">
                <span className="text-[10px] font-medium text-gray-500">Messages used</span>
      ...
      {showHistory && (
        <div
          ref={panelRef}
          className="absolute top-full left-0 right-0 z-50 bg-white border-b border-gray-100 shadow-xl shadow-gray-200/50 max-h-72 overflow-y-auto custom-scrollbar animate-slide-down"
        >
          <div className="px-4 py-2 border-b border-gray-50">
            <p className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Recent Chats</p>
          </div>
          {conversations.length === 0 ? (
            <div className="px-4 py-8 text-center">
              <div className="w-10 h-10 mx-auto mb-2 rounded-xl bg-gray-50 flex items-center justify-center">
              ...
              <p className="text-[10px] text-gray-300 mt-0.5">Start chatting to see history here</p>
            </div>
          ) : (
            <ul className="py-1">
              {conversations.map((conv, i) => (
                ...
                >
                  ...
                  <div className={`w-7 h-7 rounded-lg flex items-center justify-center flex-shrink-0 ${
                    conv.id === activeConversationId ? "bg-emerald-100 text-emerald-600" : "bg-gray-100 text-gray-400"
                  }`}>
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                  ...
                  {onDeleteConversation && (
                    <button
                      ...
                      className="p-1.5 rounded-lg opacity-0 group-hover:opacity-100 text-gray-300 hover:text-red-500 hover:bg-red-50 transition-all active:scale-[0.9]"
